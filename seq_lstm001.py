...
for epoch in range(300):
    ...
    for data in training_data:
        ...
        loss.backward()
        optimizer.step()
    print("epoch: {}, Loss: {}".format(epoch, running_loss / len(data)))
print()

input1 = make_sequence("Everybody ate the apple".split(), word_to_idx).cuda()
out = model(input1, "Everybody ate the apple".split())
print(out)